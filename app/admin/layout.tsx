...
import { LayoutDashboard, Menu, Table2, ShoppingCart, BarChart3, Settings, LogOut, Monitor, Play, UtensilsCrossed } from 'lucide-react'
...
export default function AdminLayoutWithToast({
  children,
}: {
